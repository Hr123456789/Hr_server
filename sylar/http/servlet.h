...
public:
     ...
     * @return 是否处理成功
     */
    virtual int32_t handle(hr::http::HttpRequest::ptr request
                   , hr::http::HttpResponse::ptr response
                   , hr::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (hr::http::HttpRequest::ptr request
                   , hr::http::HttpResponse::ptr response
                   , hr::http::HttpSession::ptr session)> callback;
    ...
    virtual int32_t handle(hr::http::HttpRequest::ptr request
                   , hr::http::HttpResponse::ptr response
                   , hr::http::HttpSession::ptr session) override;
private:
    /// 回调函数
    callback m_cb;
};
