...
int32_t FunctionServlet::handle(hr::http::HttpRequest::ptr request
               , hr::http::HttpResponse::ptr response
...
int32_t ServletDispatch::handle(hr::http::HttpRequest::ptr request
               , hr::http::HttpResponse::ptr response
               , hr::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(hr::http::HttpRequest::ptr request
                   , hr::http::HttpResponse::ptr response
                   , hr::http::HttpSession::ptr session) {
    response->setStatus(hr::http::HttpStatus::NOT_FOUND);
