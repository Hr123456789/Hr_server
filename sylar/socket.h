...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(hr::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(hr::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(hr::Address::ptr address);
