...
public:
     ...
     */
    TcpServer(hr::IOManager* worker = hr::IOManager::GetThis()
              ,hr::IOManager* io_woker = hr::IOManager::GetThis()
              ,hr::IOManager* accept_worker = hr::IOManager::GetThis());
     ...
     * @return 返回是否绑定成功
     单个地址绑定
     */
    virtual bool bind(hr::Address::ptr addr, bool ssl = false);
